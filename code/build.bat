@echo off
pushd ..\build
set CommonCompilerFlags=-Gm -Zi -MT -nologo -GR- -EHa- -Oi -Od -W4 -wd4100 -wd4189 -wd4201 -DDEBUG_MODE=1 -DHANDMADE_WIN32=1 -FC 
...
echo %filename%
del *.pdb >NUL 2>NUL
cl %CommonCompilerFlags% ..\code\handmade.cpp -Fmhandmade.map -LD -link -incremental:no -PDB:%filename% -EXPORT:gameUpdateAndRender -EXPORT:gameGetSoundSamples 
